...
$idProductos = isset($_POST['idProductos']) ? intval($_POST['idProductos']) : 0;
$fechaIngreso = isset($_POST['fechaIngreso']) ? $_POST['fechaIngreso'] : '';
$fechaEgreso = isset($_POST['fechaEgreso']) ? $_POST['fechaEgreso'] : '';



$query = "INSERT INTO movimientopt (idProductos, fechaIngreso, fechaEgreso) VALUES (?, ?, ?)";
$stmt = $conn->prepare($query);

if ($stmt) {
    $stmt->bind_param("iss", $idProductos, $fechaIngreso, $fechaEgreso);
    $stmt->execute();
